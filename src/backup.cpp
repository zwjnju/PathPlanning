      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          }else if(ref_vel < 47.5)
          {
              ref_vel += 0.224;
              //lane = lane * car_lane;
          }/* else if(ref_vel < 47.5 && car_s < 200)
          {
              ref_vel += 2;
              //lane = lane * car_lane;
          }*/
          ...
          for(int i=0; i<=50-previous_path_x.size(); ++i)
          {
              ...
              //std::cout<<"y_ref is: "<<y_ref<<std::endl;
              //std::cout<<"ref_yaw is: "<<ref_yaw<<std::endl;
              ...
              //std::cout<<"y_point is: "<<y_point<<std::endl;
              ...
              std::cout<<"xy[0] is: "<<xy[0]<<std::endl;
              std::cout<<"xy[1] is: "<<xy[1]<<std::endl;
